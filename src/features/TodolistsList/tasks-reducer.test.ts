...
test ('task should be removed from tasks array', () => {
    ...
    const action = removeTaskAC({ taskId: "3", todolistId: "todolistId1" });
...
test ('task status should be changed', () => {
    ...
    const action = changeTaskStatusAC({taskId: "3", status: TaskStatuses.Completed, todolistId: "todolistId1"});
...
test ('task title should be changed', () => {
    ...
    const action = changeTaskTitleAC({ taskId: "3", title: 'meowww', todolistId: "todolistId1" });
